...
const VerificationPage = () => {
  ...
  const downloadCertificate = () => {
    if (data?.certificatePath) {
      ...
      window.open(`${baseURL.replace('/api', '')}${data.certificatePath}`, '_blank');
    }
  };
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
          ...
          <div className="p-6 bg-gray-50">
            <div className="border border-gray-300 rounded-lg overflow-hidden shadow-inner bg-white max-w-3xl mx-auto">
              <iframe
                    src={`${(api.defaults.baseURL || '').replace('/api', '')}${data.certificatePath}`}
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
            ...
            <div className="p-6">
              ...
              <div className="border-2 border-gray-200 rounded-lg overflow-hidden bg-gray-800">
                ...
                <object
                  data={`${(api.defaults.baseURL || '').replace('/api', '')}${data.reuploadedFiles[activeDocIndex]}#toolbar=0&navpanes=0&scrollbar=1`}
                  type="application/pdf"
                  className="w-full h-[700px] bg-white"
                >
                  <iframe
                    src={`${(api.defaults.baseURL || '').replace('/api', '')}${data.reuploadedFiles[activeDocIndex]}#toolbar=0&navpanes=0&scrollbar=1`}
